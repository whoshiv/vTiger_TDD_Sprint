...
public class ITestListenersImplemantation implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		//Test case failure hone par method ka naam banaya hai
		String testcasename = result.getMethod().getMethodName();
		
		//Static method hai Takes Screenshot
	try {
